...
cdsp has been tested to build successfully on the following platforms:
- Windows
...
2. Generate the build files (default is Make files):
...
3. Finally you can build using the generated Makefile:
...
2. Generate the Visual studio project by opening the Visual Studio cmd prompt:
...
3. Now you should have a generated Visual Studio Solution in  your
